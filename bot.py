...
SNAKES = {
    ...
    26: 11,  # Печаль → Развлечение
    44: 9,   # Неведение → Чувственный план
    52: 35,  # План насилия → Чистилище
    61: 13,  # Негативный интеллект → Ничтожность
    63: 22,  # Тамас → План Дхармы
    71: 51,  # Раджогуна → Земля
}
ARROWS = {
    5:  69,  # Физический план → План абсолюта
    14: 68,  # Астральный план → Космическое сознание
    17: 54,  # Сострадание → План духовной преданности
    20: 38,  # Благотворительность → План жизненной энергии
    22: 51,  # План Дхармы → Земля
    27: 50,  # Самоотверженное служение → План аскетизма
    28: 45,  # Истинная религиозность → Правильное знание
    32: 57,  # План равновесия → План воздуха
    36: 55,  # Ясность сознания → Эгоизм
    59: 66,  # План реальности → План блаженства
}
